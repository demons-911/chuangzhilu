...
export default {
    ...
    methods:{
        ...
        handleScroll () {                   
            ...
            console.log(margin,523146)
            // 获取箭头的top值
            // if(this.pop <= 1){
            //     let arrows=document.getElementsByClassName('triangles')[0]
            //     let top1=window.getComputedStyle(arrows,null).top
            //     let tops=top1.replace('px','')
            //     let top3=parseFloat(tops)
            //     this.pupop=top3
            //     console.log(top3,1111111)
            //     this.pop=this.pop+1
            // }
